...
public final class FragmentNotificationBinding implements ViewBinding {
  ...
  private FragmentNotificationBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerViewNotification, @NonNull TextView tvNoNotification) {
  ...
  public static FragmentNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerViewNotification;
      ...
      return new FragmentNotificationBinding((LinearLayout) rootView, recyclerViewNotification,
          tvNoNotification);
    }
