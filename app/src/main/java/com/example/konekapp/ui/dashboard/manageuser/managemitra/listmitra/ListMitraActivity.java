...
public class ListMitraActivity extends AppCompatActivity {
    ...
    private ImageView ListMitraBackAction;
    ...
    private LinearLayout BtnAddMitra;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListMitraBackAction=findViewById(R.id.listMitraBackAction);
        ListMitraBackAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListMitraActivity.super.onBackPressed();
            }
        });

        BtnAddMitra = findViewById(R.id.btnAddMitra);
        BtnAddMitra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(ListMitraActivity.this, UpgradeMitraActivity.class);
                startActivity(i);
            }
        });
        ...
        adapter = new ListMitraAdapter(this);
