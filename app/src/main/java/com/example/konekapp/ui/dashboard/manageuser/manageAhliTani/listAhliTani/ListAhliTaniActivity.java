...
public class ListAhliTaniActivity extends AppCompatActivity {

    private List<UserModel> list;
    private List<UserModel> filteredListUser;
    private RecyclerView recyclerView;
    private ImageView ListAhliTaniBackAction;
    private ListAhliTaniAdapter adapter;
    ...
    private LinearLayout BtnAddAhliTani;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_ahli_tani);
        ...
        ListAhliTaniBackAction=findViewById(R.id.listAhliTaniBackAction);
        ListAhliTaniBackAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListAhliTaniActivity.super.onBackPressed();
            }
        });

        BtnAddAhliTani = findViewById(R.id.btnAddAhliTani);
        BtnAddAhliTani.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ListAhliTaniActivity.this, UpgradeAhliTaniActivity.class);
                startActivity(i);
            }
        });
        ...
        adapter = new ListAhliTaniAdapter(this);
