...
import com.example.konekapp.ui.dashboard.account.setting.accountsetting.editaccount.EditMitraProfileActivity;
...
public class MitraProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnEditProfMitra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent editProfMitraIntent = new Intent(MitraProfileActivity.this, EditMitraProfileActivity.class);
